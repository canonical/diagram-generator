...
- [ ] T001 Confirm the post-046 start gate and define explicit unblock conditions
...
- [ ] T010 Replace legacy arrowhead literals/fallbacks with shared canonical geometry helpers everywhere
- [ ] T011 Add focused parity coverage that proves arrowheads/shaft truncation match across preview/export paths
