...
- [ ] **T000** Reproduce the reported example-fit and ELK fidelity failures.
      **Verify**: capture whether each failure is compatibility, translation,
      layout, render, or YAML-authorship related.

- [ ] **T001** Inventory the current engine-fit contract.
...
- [ ] **T010** Define a typed example-fit/fidelity bar for exposed graph engines.
      **Verify**: `npm --prefix packages/layout-engine test`

- [ ] **T011** Tighten engine exposure or engine translation based on that bar.
      **Verify**: focused host/runtime tests.

## Phase 2: ELK Semantics And Fixture Coverage

- [ ] **T020** Fix or explicitly bound ELK `FILL` semantics for supported cases.
      **Verify**: focused ELK sizing tests.

- [ ] **T021** Fix or explicitly bound dropped-node/compound-placement failures.
