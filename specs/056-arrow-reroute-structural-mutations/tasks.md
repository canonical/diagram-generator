...
- [ ] **T000** Reproduce the reported direction-change and resize arrow failures.
      **Verify**: capture the exact failing mutation path and owner list.

- [ ] **T001** Map reroute invalidation ownership.
...
- [ ] **T010** Define a typed reroute invalidation trigger set.
      **Verify**: `npm --prefix packages/layout-engine test`

- [ ] **T011** Route page-direction and resize edits through that trigger set.
      **Verify**: focused runtime tests.

## Phase 2: Persistence and Reload

- [ ] **T020** Add persist->reload coverage for route-bearing structural edits.
      **Verify**: `npm --prefix apps/preview test`

- [ ] **T021** Confirm authored arrow identity survives reroute-bearing edits.
