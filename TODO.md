...
3. `specs/052-layers-palette-reorder/` is the active Layers palette reorder
   draft for same-parent drag and keyboard reorder using `children_order`.
4. `specs/048-elk-sizing-interaction-followup/` is Closeout Ready; reopen only
