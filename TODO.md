...
- [ ] `[H]` **Continue the authoring compiler after phase 4.** Phases 1–4 are landed (scaffold, arrows, frame-tree AST, defaults/templates). Next slice is validation warnings (phase 5), then lowering and exporters.
