...
- [ ] `[H]` **Continue the authoring compiler after phase 5.** Phases 1–5 are landed (scaffold through validation warnings). Next slice is lowering to FrameDiagram (phase 6), then exporters.
