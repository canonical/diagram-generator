...
- **Current migration caveat:** temporary server fallback is active again in `editor.js` for robustness while style/ownership parity is being completed. This is tracked in feature 007 and is not the intended final state.
