...
| 062 Parent/child hug resize propagation | `specs/062-parent-child-hug-resize-propagation/` | Closeout Ready — validated 2026-07-03 | `test-alignment-grid` now proves the full contract: switching the child to `HUG`, resizing the parent smaller, save→reload, and a real browser drag all preserve the expected propagated fit. |
