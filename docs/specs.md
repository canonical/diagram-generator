...
| 081 Diagram review workspace and feedback loop | `specs/081-diagram-review-workspace/` | Draft | Extract the proven corpus-import, FigJam comment, and comment-to-spec tools into one reusable review rung with neutral contracts, guarded adapters, registry lineage, and explicit parallel implementation lanes. |
