...
| 022 Diagram authoring AST | `specs/022-diagram-authoring-ast/` | Complete (v1) | TS diagram compiler: frame-tree AST, arrow/defaults sugar, validation, lowering through `loadFrameYaml`, Mermaid export + migration CLI. D2 export deferred. |
