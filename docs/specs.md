...
| 054 Preview persistence model TypeScript migration | `specs/054-preview-persistence-model-typescript/` | In Progress | Follow-up architecture package to retire JS-owned preview save payload assembly, move override-model ownership into TypeScript, and make save round-trip coverage part of the closeout gate for persistence work. |
