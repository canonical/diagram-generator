...
| 060 Output pane engine tabs and live rerender | `specs/060-output-pane-engine-tabs-rerender/` | Closeout Ready — direction-flip (T022) + Playwright (T040) re-earned 2026-06-29 with real gestures under spec 065 protocol | Engine switch now commits active engine intent into the frame tree before render, stamps `data-layout-engine`, and has real-render plus Playwright identity evidence. See `docs/spec-reviews/branch-060.md`. |
