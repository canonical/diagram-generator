...
| 053 Preview editor post-refactor correctness | `specs/053-preview-editor-post-refactor-correctness/` | Draft | Triage package for UI regressions after the editor/engine refactor: reliable alignment controls, v3 direction/stage resize, explicit v3 engine display, registry-filtered compatible engines, and active-engine control panels for ELK-family and Dagre engines. |
