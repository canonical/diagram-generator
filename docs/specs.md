...
| 078 Figma autolayout plugin | `specs/078-figma-autolayout-plugin/` | Draft | Local-development Figma Design plugin that recreates diagram-generator nodes as native editable auto-layout, starting with one canonical leaf node before expanding to nested parent/section imports and in-place refresh. |
