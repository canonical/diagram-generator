...
| 026 Preview shell decomposition + TS migration | `specs/026-preview-shell-decomposition-ts-migration/` | In progress | Phases 2–3 and T030 landed: save client, ELK controller, TS editor state store, and direct module calls from a slimmer `editor.js`. Remaining: layout-bridge reassessment (T031) and docs closeout (T032). |
