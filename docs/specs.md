...
| 023 Force-layout restoration | `specs/023-force-layout-restoration/` | In progress | TS-owned force runtime restored for the three canonical demos, including drag/pin/unpin/export/save behavior and stable live inspector interactions; remaining work is benchmark cleanup plus stronger automated coverage. |
