...
| 078 Figma autolayout plugin | `specs/078-figma-autolayout-plugin/` | Closeout Ready | Local-development Figma Design plugin that recreates diagram-generator nodes as native editable auto-layout, including effective Fill/Hug/Fixed sizing from the preview/YAML layout engine and a Figma readback validator. |
