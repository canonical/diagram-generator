...
| 046 Editor host endgame | `specs/046-editor-host-endgame/` | Complete | Preview-shell closeout package: future engine onboarding no longer needs to widen `editor.js` or `layout-bridge.js`; the residual `editor.js` size is now cleanup work rather than an engine-onboarding blocker. |
