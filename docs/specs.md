...
| 043 Preview shell editor TS extraction | `specs/043-preview-shell-editor-ts-extraction/` | In Progress | Finish the remaining `editor.js` decomposition work in bounded slices so the standalone preview shell becomes leaner, stabler, and easier to extend across many engine lanes. |
