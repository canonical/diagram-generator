...
| 062 Parent/child hug resize propagation | `specs/062-parent-child-hug-resize-propagation/` | Active | Resizing a hug parent must reflow hug children; default-fixed children should be authorable to hug and shrink. This is the next execution target after spec 071 per `TODO.md`. |
