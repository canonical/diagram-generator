...
| 082 Figma-to-YAML round trip | `specs/082-figma-yaml-round-trip/` | Draft | Translate supported designer layout edits from managed Figma component/autolayout diagrams into canonical YAML through stable-ID baselines, three-way merge, guarded writes, and persist→reload validation. |
