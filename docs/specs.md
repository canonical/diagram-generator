...
| 077 YAML frame → draw.io export | `specs/077-yaml-drawio-export/` | Active | TypeScript batch exporter: frame YAML → layout → mxGraph `.drawio`; ports draw.io style presets; ai-infra fixture regressions; now owns explicit light/dark draw.io theme pairs. |
