...
| 028 Diagram interchange (Mermaid & D2) | `specs/028-diagram-interchange-mermaid-d2/` | Closeout Ready | Mermaid-first hand-authored flowchart import, clear non-flowchart rejection, validated canonical-YAML safety, corpus examples, and the existing lossy D2/export interchange surface. |
