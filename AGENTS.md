...
- **Current handoff note:** this branch still has unrelated uncommitted YAML edits in `scripts/diagrams/frames/example-deployment-pipeline.yaml` and `scripts/diagrams/frames/example-platform-architecture.yaml`. Do not mix them into 047 commits unless explicitly asked.
