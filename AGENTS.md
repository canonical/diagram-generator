...
- **Current handoff note:** specs 053-060 have product closeout complete. Spec 066 is merged to `main` and archived; spec 067 remains archived as a folded review artifact. Spec 068 now owns deletion of repo-owned preview-shell/persistence dual paths so the refactor finishes by removing internal wrappers instead of normalizing them into permanent architecture.
