...
- **Current handoff note:** spec 050 is merged and archived. The follow-up UI cleanup and layers-palette reorder work should use new spec packages and typed preview-shell owners; do not route new behavior through `scripts/preview/editor.js` or `scripts/preview/layout-bridge.js`.
