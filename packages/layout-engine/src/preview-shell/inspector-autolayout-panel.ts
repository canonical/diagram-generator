...
export function renderSingleSelectionAutolayoutPanel(
  ...
  const quotedCid = quotePreviewInlineJsString(cid);
  ...
  if (panelState.isContainer) {
    ...
    html += `<select class="bf-input" onchange="setFrameProp(${quotedCid},'direction',this.value)">`;
    ...
    html += ` onchange="setFrameProp(${quotedCid},'gap_delta',this.value)"`;
  ...
  html += `<select class="bf-input${panelState.wCoerced ? ' dg-coerced' : ''}" onchange="setFrameProp(${quotedCid},'sizing_w',this.value)">`;
  ...
  if (panelState.showWidthFixedInput) {
    ...
    html += ` onchange="setFrameSize(${quotedCid},'width',parseFloat(this.value))"`;
    html += ' style="width:60px;margin-left:4px">';
    html += `<select class="bf-input" style="width:50px;margin-left:2px" onchange="setWidthUnit(this.value,${quotedCid})">`;
  ...
  if (panelState.showWidthMinMax) {
    ...
    html += ' placeholder="—"';
    html += ` onchange="setFrameProp(${quotedCid},'min_width',this.value)"`;
    ...
    html += ' placeholder="—"';
    html += ` onchange="setFrameProp(${quotedCid},'max_width',this.value)"`;
    html += ' style="width:52px">';
    html += '</div>';
  }
  ...
  if (panelState.showWidthTextMeasure) {
    ...
    html += ` onchange="setFrameProp(${quotedCid},'max_width_chars',this.value)"`;
  ...
  if (panelState.showWidthFillWeight) {
    ...
    html += ` onchange="setFrameProp(${quotedCid},'fill_weight',parseFloat(this.value))"`;
    html += ' style="width:52px">';
    html += '</div>';
  }

  html += '<div class="field"><span class="label">Height</span>';
  html += `<select class="bf-input${panelState.hCoerced ? ' dg-coerced' : ''}" onchange="setFrameProp(${quotedCid},'sizing_h',this.value)">`;
  ...
  if (panelState.showHeightFixedInput) {
    ...
    html += ` onchange="setFrameSize(${quotedCid},'height',parseFloat(this.value))"`;
    html += ' style="width:60px;margin-left:4px">';
    html += `<select class="bf-input" style="width:50px;margin-left:2px" onchange="setHeightUnit(this.value,${quotedCid})">`;
  ...
  if (panelState.showHeightMinMax) {
    ...
    html += ' placeholder="—"';
    html += ` onchange="setFrameProp(${quotedCid},'min_height',this.value)"`;
    html += ' style="width:52px">';
    ...
    html += ' placeholder="—"';
    html += ` onchange="setFrameProp(${quotedCid},'max_height',this.value)"`;
    html += ' style="width:52px">';
    html += '</div>';
  }
  ...
  if (panelState.showPositionType) {
    ...
    html += `<select class="bf-input" onchange="setFrameProp(${quotedCid},'position',this.value)">`;
    ...
    if (panelState.showAbsoluteOffsetControls) {
      ...
      html += ` onchange="setFrameProp(${quotedCid},'x',parseInt(this.value))"`;
      html += ' style="width:52px">';
      ...
      html += ` onchange="setFrameProp(${quotedCid},'y',parseInt(this.value))"`;
      html += ' style="width:52px">';
      html += '</div>';
    }
  }
